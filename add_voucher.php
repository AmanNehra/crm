...
?>"/></td>
	...
	$rt=$_SESSION['SESS_id'];
    list($d,$n,$rty)=mysql_fetch_array(mysql_query("SELECT department,name,id FROM department_list where user=$rt"));
	?>	
        <tr>
...
<option <?php if($value['department']==$d){ echo "selected"; } ?> value="<?php echo $value['department']; ?>"><?php echo $value['department']; ?></option>                 
   ...
   <input type="hidden" name="salseman_id" id="salseman_id" value="<?php echo $rty ; ?>" />
   <input type="hidden" name="salseman" id="salseman" value="<?php echo $n; ?>"/>   
