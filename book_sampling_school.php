...
$q="INSERT INTO book_sample (id_of_name,name, address, city,district, state, country,salseman_id,salesman_name,sampling_type,group1,series,relate,remarks,sampling_Date) VALUES ('$sid','$school_name','$address','$city', '$district','$state', '$country','$salesman_id','$salesman_name','$sampling_type','$group','$series','SCHOOL','$remarks','$sampling_Date' )";
  ...
  for($j=1; $j<=$len; $j++)
     {
	   ...
	   if($sampling_type!='BOOKS_GIVEN')
	    $q2=mysql_query("INSERT INTO book_sample_details (uid,salseman_id,teacher_id,relate,sampling_Date) VALUES('$uid','$salesman_id','$teacher_id','SCHOOL','$sampling_Date')")  or die( mysql_error());
		
	   else if(isset($book_id))	     
		$q2=mysql_query("INSERT INTO book_sample_details (uid,salseman_id,teacher_id,book_id,qty,relate,sampling_Date) VALUES('$uid','$salesman_id','$teacher_id','$book_id','$specimen_qty','SCHOOL','$sampling_Date')")  or die( mysql_error());
...
<option value="others">Others</option>
          ...
          <tr>
			<th>Group</th>
					<td><select name="group" id="group" onchange="sampleBookList();TeacherList(<?php echo $sid; ?>)" style="width: 183px;;border: 1px solid;height: 30px;border-radius: 4px;"> 
		...
		<table style="margin-left: 80px; width:50%; float:right">
		 ...
		 <td width="68">Select</td>
		  <td width="242">Teacher Name</td>		  
		  <td width="165">Subject</td>	
		  <td width="100" >Last Visit</td>	  
		 </tr>		 
		 
         <tr >
		  <td colspan="4" id="booklist1"></td>
		 </tr>
		</table>
	    </td></tr>
