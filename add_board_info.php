...
<div id="page-heading">
  <h1>Add New Board Information</h1>
...
<tr>
   ...
   <th valign="top">Category:</th>
			<td>
            <input type="text" class="inp-form" name="category" id="category" value="BOARD" readonly="readonly"/>
            </td>
   <th valign="top">Board Details:</th>
			<td>
            <input type="text" class="inp-form" name="name" id="name" required />            </td>
