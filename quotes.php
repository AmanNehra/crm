				 ...
				 $rest = substr($dcty, 0, 3);
				  ...
				  ?>
                   <td><?php echo $count; ?></td>
                    <td> <!--<a href="javascript:void(0);" style="color:#FF0000; text-decoration:underline; font-weight:bold" title="View Detail" onClick="PopupCenter('detail.php?id=<?php echo base64_encode(convert_uuencode($ag_id));?>', 'myPop1',1000,700);"><?php echo $code; ?></a>-->
                    
                    
                    <a href="detail.php?id=<?php echo base64_encode(convert_uuencode($ag_id));?>" style="color:#FF0000; text-decoration:underline; font-weight:bold"><?php echo strtoupper($code); ?></a>
                    </td>
