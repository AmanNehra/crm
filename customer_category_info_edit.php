...
function update()
 {
	...
	$sq=mysql_query("UPDATE corporate_list SET category='$name' where category='$name12'") or die(mysql_error());
	...
	if($sq)
	{
		...
		else{ header('location:customer_category_info_edit.php?id='.$id);}
 } 
