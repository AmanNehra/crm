...
//echo "<pre>"; print_r ($_REQUEST); die("submit");
	...
	$q="UPDATE book_sample SET name='$name',address='$address', city='$city',district='$district', state='$state', country='$country',salseman_id='$salesman_id',salesman_name='$salesman_name',sampling_type='$sampling_type', group1='$group',series='$series',remarks='$remarks',sampling_Date='$sampling_Date',app='$app',view='1' where id='$id'";
...
header("Location : http://mascoteducation.com/crm/book_sampling_details_new.php");
echo "<script>window.location.href='http://mascoteducation.com/crm/book_sampling_details_new.php';</script>";
...
<?php if(($success!="")){?>
	<div id="message-green">
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="green-left"><?php echo $success;
...
<a href="book_sampling_details_new.php" style="color:#FFFFFF;"><div class="addin">
    	Back
    </div></a>
...
<tr>
    ...
    <th>Distt:</th>
        ...
        <?php
			  ...
			  ?>			  
			     <option  value="<?php echo $value['id']; ?>" <?php if($data->salseman_id==$value['id']){ echo "selected"; $sel_name=$value['name'];  } ?> ><?php echo $value['name']; ?></option>
			  <?php 
			     }   
              ?>
  </select></td><input type="hidden" name="salesman_id_hidden" id="salesman_id_hidden" />
                <input type="hidden" name="salesman_name" id="salseman_name" value="<?php echo $sel_name; ?>"  />
		<th valign="top">Sampling type:</th>
			...
			<option value="follow_up"  <?php if($data->sampling_type=="FOLLOW_UP"){ echo "selected"; } ?> >Follow up</option>
			<option value="others"  <?php if($data->sampling_type=="OTHERS"){ echo "selected"; } ?> >Others</option>
		...
		<?php
			  ...
			  ?>			  
				 <option  value="<?php echo $value['subject']; ?>" <?php if($data->group1==$value['subject']){ echo "selected";  } ?>><?php echo $value['subject']; ?></option>
			  <?php 
				 }   
			  ?>
	</select>      </td>					
		...
		<?php
			  ...
			  ?>			  
				 <option  value="<?php echo $value['series']; ?>" <?php if($data->series==$value['series']){ echo "selected";  } ?>><?php echo $value['series']; ?></option>
			  <?php 
				 }   
			  ?>
	</select></td>
    ...
    <tr>
		<th>Verification</th>
		<td valign="top" colspan="3">
		  <textarea class="inp-form33" style=" width:100%; height:50px" name="app"><?php echo $data->app; ?></textarea>
		 </td> 		
		</tr>
	<tr>
