...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>All Company MIS Listing</h1>
	</div>
    <div style="width:100%;">
      
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="company_mis.php" style="color:#FFFFFF;">Add New Company MIS Information</a></span>
    </div>
			...
			<div id="table-content">
				...
				<tr>
                   ...
                   <!-- <th class="table-header-repeat line-left"><a>Profile Image</a></th>-->
					...
					<th class="table-header-repeat line-left minwidth-1"><a>Company Name</a>	</th>
                    <th class="table-header-repeat line-left minwidth-1"><a>Company Address</a>	</th>
					...
					<th class="table-header-repeat line-left minwidth-1"><a>Fax</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a>Website</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a>Email</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a>Add Mis</a>	</th>
	...
	*/
	...
	$tbl_name="misCompanyMaster";		//your table name
	...
	*/
	...
	$targetpage = "company_mis_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
...
if ($i % 2 == 0) {
  ...
  echo "<tr class='alternate-row'>";
				  ...
				  <td><?php echo $count; ?></td>
                    ...
                    <td align="center"><a href="company_mis_sub.php?sid=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Add Sub Company mis" class="icon-4 info-tooltip"></a></td>
					
					<td class="options-width">
                    
					<a href="company_mis_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
                  <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=com_mis&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onClick="if(!confirm('Are you sure, you want to delete this Information ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
					<?php } ?>
					</td>
				<?php //}?>
