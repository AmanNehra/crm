...
$name=trim(strtoupper($_REQUEST['date'])); 
...
<div id="page-heading">
  <h1>Add New Saturday off Information</h1>
...
<tr>
   ...
   <th valign="top">Category:</th>
			<td>
            <input type="text" class="inp-form" name="category" id="category" readonly="readonly" value="SATURDAY OFF"/>
            </td>
   <th valign="top">Date:</th>
			<td>
            <input type="text" class="inp-form" name="date" id="date" />            </td>
