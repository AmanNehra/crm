...
$sql=mysql_query("INSERT INTO finalised (id,category, date) VALUES ('','$category', '$date')")or die(mysql_error());
...
<div id="page-heading">
  <h1>Add New Finalised  Information</h1>
...
<tr>
   ...
   <th valign="top">Category:</th>
			<td>
            <input type="text" class="inp-form" name="category" id="Category" readonly="readonly" value="FINALISED" />
            
   <th valign="top">Finalised Date:</th>
           <td>
            <input type="text" class="inp-form" name="final_date" id="final_date" /></td>
	</tr> 
