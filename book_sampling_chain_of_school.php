...
$q="INSERT INTO book_sample (id_of_name,name, address, city,district, state, country,salseman_id,salesman_name,sampling_type,group1,series,relate,remarks,sampling_Date) VALUES ('$sid','$name','$address','$city', '$district','$state', '$country','$salesman_id','$salesman_name','$sampling_type','$group','$series','CHAIN','$remarks','$sampling_Date')";
  ...
  for($j=1; $j<=$len; $j++)
     {
	   ...
	   if($sampling_type!='BOOKS_GIVEN')
	    $q2=mysql_query("INSERT INTO book_sample_details (uid,salseman_id,teacher_id,relate,sampling_Date) VALUES('$uid','$salesman_id','$teacher_id','CHAIN','$sampling_Date')")  or die( mysql_error());
		
	   else if(isset($book_id))	     
			$q2=mysql_query("INSERT INTO book_sample_details (uid,salseman_id,teacher_id,book_id,qty,relate,sampling_Date) VALUES('$uid','$salesman_id','$teacher_id','$book_id','$specimen_qty','CHAIN','$sampling_Date')")  or die( mysql_error());
...
<div id="page-heading">
  <h1>  Chain Of School Sampling</h1>
</div>
...
<option value="others">Others</option>
          ...
          <tr>
			<th>Group</th>
					<td><select name="group" id="group" onchange="sampleBookList();schoolChainList(<?php echo $sid; ?>)" style="width: 183px;;border: 1px solid;height: 30px;border-radius: 4px;"> 
		...
		<?php
			  ...
			  ?>
					...
					<th>Series</th>
					<td><select name="series" id="series" onchange="sampleBookList();schoolChainList(<?php echo $sid; ?>)" style="width: 183px;;border: 1px solid;height: 30px;border-radius: 4px;"> 
			<option value="" selected="selected"> Plz Select</option>
		<?php
		...
		<table style="margin-left: 80px; width:50%; float:right">
		 <tr id="" >
		 <td width="77">Select</td>
		 <td width="232">Teacher Name</td>  
