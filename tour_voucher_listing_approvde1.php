...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Non Approved Tour Voucher Listing Validate1</h1>
	</div>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
                   ...
                   <th class="table-header-repeat line-left"><a></a>Tour Advance</th>		  				   
	...
	*/
	...
	$targetpage = "tour_voucher_listing_approvde1.php"; 	//your file name  (the name of this file)
	$limit = 10;
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  ?>
					...
					<a href="tour_voucher_approved1.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>	
				</td>
				<?php //}?>
