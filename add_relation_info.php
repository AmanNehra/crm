...
$query=mysql_query("SELECT name FROM  relation WHERE category = '$category'");
  ...
  if($f!=1)
   {
$sql=mysql_query("INSERT INTO relation (id,category, name, date) VALUES ('','$category', '$name','$date')")or die(mysql_error());
...
<div id="page-heading">
  <h1>Add New Relation Information</h1>
...
<tr>
   ...
   <th valign="top">Category:</th>
			<td>
            <input type="text" class="inp-form" name="category" id="category"  readonly="readonly" value="RELATION"/>
            </td>
