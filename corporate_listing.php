...
<div id="content">
    ...
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="corporate.php" style="color:#FFFFFF;">Add New Corporate</a></span>
    </div>
	...
	<td> 
         <select name="searchby1" class="search_by">
				...
				<option <?php if($searchby1=="dayoff") echo 'selected="selected"';?>VALUE="dayoff">Day off</option>
				<option <?php if($searchby1=="specialisation1") echo 'selected="selected"';?>VALUE="specialisation1">Specialisation1</option>
				<option <?php if($searchby1=="specialisation2") echo 'selected="selected"';?>VALUE="specialisation2">Specialisation2</option>
				<option <?php if($searchby1=="specialisation3") echo 'selected="selected"';?>VALUE="specialisation3">Specialisation3</option>
				<option <?php if($searchby1=="specialisation4") echo 'selected="selected"';?>VALUE="specialisation4">Specialisation4</option>						
	...
	<td> 
         <select name="searchby2" class="search_by">
				...
				<option <?php if($searchby2=="dayoff") echo 'selected="selected"';?>VALUE="dayoff">Day off</option>
				<option <?php if($searchby2=="specialisation1") echo 'selected="selected"';?>VALUE="specialisation1">Specialisation1</option>
				<option <?php if($searchby1=="specialisation2") echo 'selected="selected"';?>VALUE="specialisation2">Specialisation2</option>
				<option <?php if($searchby1=="specialisation3") echo 'selected="selected"';?>VALUE="specialisation3">Specialisation3</option>
				<option <?php if($searchby1=="specialisation4") echo 'selected="selected"';?>VALUE="specialisation4">Specialisation4</option>						
				        </select>
			...
			<div id="table-content">
				...
				<tr>
                   ...
                   <!-- <th class="table-header-repeat line-left"><a>Profile Image</a></th>-->
                    ...
                    <?php //}?>
					<th class="table-header-repeat line-left"><a>Phone/Mob</a></th>
                    <th class="table-header-repeat line-left"><a>Category</a></th>					 
					<th class="table-header-options line-left" style="border-right:1px solid;"><a>Add Corporate</a></th>
	...
	*/
	...
	$targetpage = "corporate_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  <td><?php echo $count; ?></td>
					...
					<td><?php echo $row['phone1'].'<br>'.$row['phone2']; ?></td>
					<td><?php echo $row['category']; ?></td>
					<td align="center"><a href="corporate2.php?sid=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Corporate Master" class="icon-4 info-tooltip"></a></td>
					<td align="center"><a href="book_sampling_corporate.php?sid=<?php echo base64_encode(convert_uuencode($row['id']));?>&type=<?php echo base64_encode(convert_uuencode($tbl_name));?>" title="Teacher Master"><img src="images/sicon.png"/></a></td>
					<td class="options-width">
                    
					<a href="corporate_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
                  <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=corporate&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onclick="if(!confirm('Are you sure, you want to delete this Corporate Details ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				<?php } ?>
