...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>All working Area Listing</h1>
	</div>
    <div style="width:100%;">
     
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="working_area.php" style="color:#FFFFFF;">Add New Working Area</a></span>
    </div>
	...
	*/
	...
	$tbl_name="working_area";		//your table name
	...
	*/
	...
	$targetpage = "working_area_listring.php"; 	//your file name  (the name of this file)
	$limit = 10;
...
if ($i % 2 == 0) {
  ...
  echo "<tr class='alternate-row'>";
				  ...
				  $c1="";
				  //To know salesman name				  
				  $q=mysql_query("SELECT name FROM department_list WHERE user='$salesman_id'") or die(mysql_error());
				  $data=mysql_fetch_assoc($q);
				  $salesman=$data['name'];
				  //End
				  
				  //To Know working city of salesman
				  ...
				  ?>
					...
					<a href="working_area_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>&salesman_id=<?php echo base64_encode(convert_uuencode($row['salesman_id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
                  <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=working&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onClick="if(!confirm('Are you sure, you want to delete this Information ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				 <?php } ?>
				</td>	
