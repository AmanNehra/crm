...
<div class="mbt-box01">
<div class="mbt-box0201"><div class="mbt-box-text01">Mascot Education</div></div>
...
<div class="mbt-box0201"><div class="mbt-box-text01">Reports</div></div>
 ...
 <?php if($user['user_type'] < 7) { ?>
<div class="mbt-box0202">
<div class="report-img-box" style="background-color: #BDBAB1;width: 63px;"><img src="images/login-page-images/photo.png" width="60" height="60" /></div>
...
<div class="report-img-text01"><a href="book_sampling_details_new.php">Sampling Verification</a><br /></div>
</div>
...
<div class="report-img-box" style="background-color: #BDBAB1;width: 63px;"><img src="images/login-page-images/photo.png" width="60" height="60" /></div>
<div class="report-img-text">
<div class="report-img-heading">School Sampling Verification</div>
<div class="report-img-text01"><a href="book_sampling_details_new.php">Link 1</a><br /></div>
</div>
