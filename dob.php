...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>All Date Of Birth Information Listing</h1>
	</div>
    <div style="width:100%;">
      <?php if($user==1){ ?>
    <?php }?>
			...
			<div id="table-content">
				...
				<tr>
                   ...
                   <th class="table-header-repeat line-left"><a>Organization</a></th>
                    <th class="table-header-repeat line-left"><a>Dob</a></th>	
...
//echo $page;die;
	...
	/* Get data. */
	$sql = "SELECT 'teacher_master_list',uid,teacher,dob,city,district,state FROM teacher_master_list where dob IN ('$date[0]','$date[1]','$date[2]') UNION ALL select 'corporate_sub',uid,persion,dob,city,district,state from corporate_sub where dob IN ('$date[0]','$date[1]','$date[2]') UNION ALL select 'department_list', id,name,dob,city,district,state from department_list where dob IN ('$date[0]','$date[1]','$date[2]') UNION ALL select 'chain_school_sub',sid,member,dob,city,district,state from chain_school_sub where dob IN ('$date[0]','$date[1]','$date[2]') ";
