...
<div id="page-heading"><h1>Add New User Role</h1></div>
<a href="userrole_listing.php" style="color:#FFFFFF;"><div class="addin">
    	Back
    </div></a>
<form action="userrole_submit.php" method="post" enctype="multipart/form-data" id="formoid" name="form">
...
<tr>
	...
	<td>
		...
		<tr>
			<th valign="top">User Role name:</th>
			<td><input type="text" class="inp-form" name="role_name" id="role_name" /></td>
			<td></td>
		</tr>
		
	<tr>
        <th>Status:</th>
        <td> <input type="radio" name="status" id="status1" value="Active"> Active
			<input type="radio" name="status" id="status2" value="In-Active">In-Active</td>
    ...
    <tr>
       ...
       <?php  
		...
		{
			?> 
			<input style="height: 13px; margin-right:6px;" type="checkbox" name="page[]" id="<?php echo $i;?>" onclick="return check_option(this.id);" value="<?php echo $row['id']; ?>"><span style="padding-right: 20px;"><?php echo $row['page_name']; $i++; ?>  </span> <?php
		} 
		?>
		</td>
	</tr>
	...
	<tr id="51" style="display:none;line-height: 35px;">
	 <th valign="top">Mis</th>
	  ...
	  <input style="height: 13px; margin-right:6px;" type="checkbox" name="subpage[]" value="<?php echo 55; ?>"><span style="padding-right: 20px;"><b>User</b></span>
	  <input style="height: 13px; margin-right:6px;" type="checkbox" name="subpage[]" value="<?php echo 55; ?>"><span style="padding-right: 20px;"><b>User Role</b></span>
