...
?>
	...
	<td> 
         <select name="searchby1" class="search_by">
				...
				<option <?php if($searchby1=="code") echo 'selected="selected"';?>VALUE="code">School Code</option>	
				<option <?php if($searchby1=="school") echo 'selected="selected"';?>VALUE="school">School Name</option>
				<option <?php if($searchby1=="teacher") echo 'selected="selected"';?>VALUE="teacher">Teacher Name</option>							
	...
	<td> 
         <select name="searchby2" class="search_by">
		        <option value="" selected="selected">Plz Select</option> 
				<option <?php if($searchby2=="code") echo 'selected="selected"';?>VALUE="code">School Code</option>	
				<option <?php if($searchby2=="school") echo 'selected="selected"';?>VALUE="school">School Name</option>
				<option <?php if($searchby2=="teacher") echo 'selected="selected"';?>VALUE="teacher">Teacher Name</option>							
	...
	*/
	...
	$targetpage = "teacher_master_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
...
if ($i % 2 == 0) {
  ...
  echo "<tr class='alternate-row'>";
				  ...
				  $class=unserial($class);
					...
					$query_schoolname=mysql_query("select name from master_list where id='".$row['uid']."'") or die(mysql_error());
					$data_schoolname=mysql_fetch_array($query_schoolname);			
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  <td><?php echo $count; ?></td>
                     <td><?php echo $data_schoolname['name']; ?></td>
                    ...
                    <td align="center"><a href="book_sampling_teacher.php?sid=<?php echo base64_encode(convert_uuencode($row['id']));?>&type=<?php echo base64_encode(convert_uuencode($tbl_name));?>" title="Teacher Master"><img src="images/sicon.png"/></a></td>
					<td class="options-width">
                    
					<a href="teacher_master_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
                  <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=teacher1&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onclick="if(!confirm('Are you sure, you want to delete this Master Details ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				<?php } ?>
