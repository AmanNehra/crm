...
$Q1=mysql_query("UPDATE tour SET executive_id='$executive_id',executive='$executive',designation= '$designation', from_date='$from_date',to_date='$to_date',advance='$advance',status=2, approved_by='$usname' WHERE id='$id'") or die (mysql_error()); 
$len=$_REQUEST['len'];
...
for($i=1;$i<=7;$i++)
  {
   ...
   if($date!="" && $station!="" && $purpose!=""){
	...
	if($Q1 && $Q2 && $Q3)
	   header("location:tour_voucher_listing_approvde2.php"); 
}
...
<tr>
    ...
    <tr>
        ...
        <th valign="top">Tour Advance :</th>
			<td><input type="text" class="inp-form" name="advance"  value="<?php echo $row['advance']; ?>" id="advance"/></td>
         <th valign="top">&nbsp;</th>
			<td>&nbsp;</td>
        </tr>
	   <tr>
