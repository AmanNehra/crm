...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>All Expense Master Listing</h1>
	</div>
    <div style="width:100%;">
     
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="expense_master.php" style="color:#FFFFFF;">Add New Expense Master</a></span>
    </div>
	...
	<td> 
         <select name="searchby1" class="search_by" >
				...
				<option <?php if($searchby1=="report_no") echo 'selected="selected"';?>VALUE="report_no">Report No</option>	
				<option <?php if($searchby1=="executive_name") echo 'selected="selected"';?>VALUE="executive_name">Executive Name</option>						
				<option <?php if($searchby1=="designation") echo 'selected="selected"';?>VALUE="designation">Designation</option>
				<option <?php if($searchby1=="branch") echo 'selected="selected"';?>VALUE="branch">Branch Office</option>
				<option <?php if($searchby1=="report_date") echo 'selected="selected"';?>VALUE="report_date">Date</option>
				<option <?php if($searchby1=="town_visited") echo 'selected="selected"';?>VALUE="town_visited">Town Visite</option>
				<option <?php if($searchby1=="advance") echo 'selected="selected"';?>VALUE="advance">Tour Advance Bal</option>
				<option <?php if($searchby1=="tel") echo 'selected="selected"';?>VALUE="tel">Telephone</option>				
        </select>
      </td> 
	...
	<td> 
         <select name="searchby2" class="search_by">
		        <option value="" selected="selected">Plz Select</option> 			
				<option <?php if($searchby2=="report_no") echo 'selected="selected"';?>VALUE="report_no">Report No</option>	
				<option <?php if($searchby2=="executive_name") echo 'selected="selected"';?>VALUE="executive_name">Executive Name</option>						
				<option <?php if($searchby2=="designation") echo 'selected="selected"';?>VALUE="designation">Designation</option>
				<option <?php if($searchby2=="branch") echo 'selected="selected"';?>VALUE="branch">Branch Office</option>
				<option <?php if($searchby2=="report_date") echo 'selected="selected"';?>VALUE="report_date">Date</option>
				<option <?php if($searchby2=="town_visited") echo 'selected="selected"';?>VALUE="town_visited">Town Visite</option>
				<option <?php if($searchby2=="advance") echo 'selected="selected"';?>VALUE="advance">Tour Advance Bal</option>
				<option <?php if($searchby2=="tel") echo 'selected="selected"';?>VALUE="tel">Telephone</option>				
	...
	function export_excel()
	{
	 ...
	 <form name="search_export" id="search_export" action="expense_master_listing_export.php" method="post">
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
				   ...
				   <th class="table-header-repeat line-left"><a>Report Number </a></th>
				   <th class="table-header-repeat line-left"><a>Date</a></th>
				   <th class="table-header-repeat line-left"><a>Branch Office </a></th>
                   ...
                   <th class="table-header-repeat line-left"><a>Tour Advance</a></th>		
 				   <th class="table-header-repeat line-left"><a>Grand Total</a></th>
                   <th class="table-header-repeat line-left"><a>Advance Remaining</a></th>                   
	...
	*/
	...
	$targetpage = "expense_master_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  ?>
					...
					<td class="options-width">
                     ...
                     <?php } else {  */ ?>
					<a href="expense_master_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
                  	 
                  <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=expense_master&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onClick="if(!confirm('Are you sure, you want to delete this Information ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				 <?php } ?>
				 <?php /* }  */ ?>
				</td>
				<?php //}?>
