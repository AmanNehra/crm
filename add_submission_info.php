...
$query=mysql_query("SELECT date FROM  submission WHERE category = '$category'");
  ...
  if($f!=1)
   {
$sql=mysql_query("INSERT INTO submission (category, date) VALUES ('$category', '$date')")or die(mysql_error());
...
<div id="page-heading">
  <h1>Add New Submission Information</h1>
...
<tr>
   ...
   <th valign="top">Category:</th>
			<td>
            <input type="text" class="inp-form" name="category" id="Category"  readonly="readonly" value="SUBMISSION"/></td>
    <th valign="top">Submission Date:</th>
        
            <td><input type="text" class="inp-form" name="sub_date" id="sub_date" /></td>
	</tr> 
