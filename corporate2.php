...
<div id="page-heading"><h1>Add New Corporate </h1></div>
...
<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        <tr>
			...
			<th valign="top" style="width: 66px">Contact Persion:</th>
			<td><input type="text" class="inp-form" name="persion" id="persion" /></td>
		</tr> 
		<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
                   ...
                   <th class="table-header-repeat line-left"><a>Contact Persion</a></th>
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  ?>
					...
					<a href="corporate2_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>&sid=<?php echo base64_encode(convert_uuencode($sid));?>" title="Edit" class="icon-1 info-tooltip"></a>
                    <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=corporate2&id=<?php echo base64_encode(convert_uuencode($row['id']));?>&sid=<?php echo base64_encode(convert_uuencode($sid));?>" onClick="if(!confirm('Are you sure, you want to delete this Information ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				  <?php } ?>
