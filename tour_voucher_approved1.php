...
$Q1=mysql_query("UPDATE tour SET executive_id='$executive_id',executive='$executive',designation= '$designation', from_date='$from_date',to_date='$to_date',advance='$advance',status=1, approved_by='$usname' WHERE id='$id'") or die (mysql_error()); 
...
for($i=1;$i<=7;$i++)
  {
   ...
   if($date!="" && $station!="" && $purpose!=""){
	...
	if($Q1 && $Q2 && $Q3)
	   header("location:tour_voucher_listing_approvde1.php"); 
}
