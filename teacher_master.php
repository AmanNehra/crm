...
$sql=mysql_query("INSERT INTO teacher_master_list (uid,school,code, teacher, designation, address, dob, mstatus, relation,city, district, state, country, pin, std,phone1,mobile1, mobile2, email, subject, item, class) VALUES ('$sid','$school','$code', '$teacher', '$designation', '$address', '$dob','$mstatus', '$relation','$city','$district', '$state', '$country', '$pin', '$std', '$phone1','$mobile1', '$mobile2', '$email', '$subject', '$item','$class')")or die(mysql_error());
...
<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        <tr>
			...
			<td><input type="text" class="inp-form" name="school" id="school" value="<?php echo $row['name']; ?>" readonly />
