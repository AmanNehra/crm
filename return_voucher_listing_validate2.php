...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading" style="display:inline;width:80%; float:left">
		<h1>Non Approved Return Voucher Listing</h1>
	</div>
	...
	*/
	...
	{	
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE status='' AND `salseman_id` IN ($salesman_ids) ";	
	}
	...
	$targetpage = "return_voucher_listing_validate2.php"; 	//your file name  (the name of this file)
	$limit = 10;
...
//echo $page;die;
	...
	{
	 $sql = "SELECT * FROM $tbl_name WHERE status='' AND `salseman_id` IN ($salesman_ids) ORDER BY id desc LIMIT $start, $limit";
	}
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  <td><?php echo $count; ?></td>
					...
					<a href="return_voucher_validate.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>                  
