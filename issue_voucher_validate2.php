...
$query="UPDATE all_voucher SET qty='$approved' WHERE uid='$id' AND book_id='$book_id' AND relate='1' ";
$q1=mysql_query($query)  or die( mysql_error());

}
$query="UPDATE issue_voucher SET status='2',approved_by='$usname' WHERE id='$id' ";
$q2=mysql_query($query) or die( mysql_error());

if($q1 && $q2)
  header("location:issue_voucher_listing_validate2.php");
}
...
<div id="page-heading">
  <h1>Specimen Voucher Validate 2 </h1>  
</div>
        ...
        <tr>
         ...
         <tr >
		  ...
		  <input type="hidden" name="book_id_<?php echo $i; ?>" value="<?php echo $row['book_id'];?>"  class="textsmall"/>		
			...
			<td style="margin-left:20px;" ><input type="text" name="qty_<?php echo $i; ?>" value="<?php echo $row['salesman_qty'];?>" class="textsmall" readonly=""/></td>
