...
<div id="content">
	...
	*/
	...
	if($user <=4 ) 
	{  
		$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE app = '' $search_val";			
	}
	else
	{	
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE app = '' $salesman_area  $search_val";	
	}
...
//echo $page;die;
    ...
    if($user <=4)
	{ 
	 $sql = "SELECT * FROM $tbl_name WHERE app = '' $search_val ORDER BY id desc LIMIT $start, $limit";
	}
	else
	{
	 $sql = "SELECT * FROM $tbl_name WHERE app = '' $salesman_area  $search_val ORDER BY id desc LIMIT $start, $limit";
	}	
