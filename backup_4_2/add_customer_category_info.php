...
<div id="page-heading">
  <h1>Add New Customer Category Information</h1>
...
<tr>
   ...
   <th valign="top">Category:</th>
			<td>
            <input type="text" class="inp-form" name="category" id="category" readonly="readonly" value="CUSTOMER CATEGORY"/>
            </td>
   <th valign="top">Customer Details:</th>
			<td>
...
messages: {
    category:{
                 required: "Enter customer category",                
    },
     name: {
