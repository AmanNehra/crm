...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>All Workshop Voucher Listing</h1>
	</div>
    <div style="width:100%;">
      
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="workshop.php" style="color:#FFFFFF;">Add New Workshop Master</a></span>
    </div>
	...
	<td> 
         <select name="searchby1" class="search_by" >
				...
				<option <?php if($searchby1=="venue") echo 'selected="selected"';?>VALUE="venue">Venue</option>						
				<option <?php if($searchby1=="v_details") echo 'selected="selected"';?>VALUE="v_details">Venue Details</option>
				<option <?php if($searchby1=="proposed_date") echo 'selected="selected"';?>VALUE="proposed_date">Proposed Date</option>
				<option <?php if($searchby1=="resource_person") echo 'selected="selected"';?>VALUE="resource_person">Resource Person</option>	
				<option <?php if($searchby1=="subject") echo 'selected="selected"';?>VALUE="subject">Subject Person</option>
	...
	<td> 
         <select name="searchby2" class="search_by">
				...
				<option <?php if($searchby2=="venue") echo 'selected="selected"';?>VALUE="venue">Venue</option>						
				<option <?php if($searchby2=="v_details") echo 'selected="selected"';?>VALUE="v_details">Venue Details</option>
				<option <?php if($searchby2=="proposed_date") echo 'selected="selected"';?>VALUE="proposed_date">Proposed Date</option>
				<option <?php if($searchby2=="resource_person") echo 'selected="selected"';?>VALUE="resource_person">Resource Person</option>	
				<option <?php if($searchby2=="subject") echo 'selected="selected"';?>VALUE="subject">Subject Person</option>
	...
	function export_excel()
	{
	 ...
	 <form name="search_export" id="search_export" action="workshop_listing_export.php" method="post">
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
				   ...
				   <th class="table-header-repeat line-left"><a>School Detail</a></th>
				   <th class="table-header-repeat line-left"><a>Vanue Detail</a></th>
                   <th class="table-header-repeat line-left"><a>Proposed Date</a></th>
                   <th class="table-header-repeat line-left"><a>Resource Person</a></th>
				   <th class="table-header-repeat line-left"><a>Estimated Cost</a></th>
				   <th class="table-header-repeat line-left"><a>Estimated Rent</a></th>
				   <th class="table-header-repeat line-left"><a>Business Goal</a></th>
	...
	*/
	...
	$tbl_name="workshop";		//your table name
	...
	*/
	...
	$targetpage = "workshop_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
...
if ($i % 2 == 0) {
  ...
  echo "<tr class='alternate-row'>";
				  ...
				  ?>
					...
					<a href="workshop_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
                  <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=workshop&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onClick="if(!confirm('Are you sure, you want to delete this Information ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				<?php } ?>
				</td>
				<?php //}?>
