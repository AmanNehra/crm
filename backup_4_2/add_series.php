...
$query=mysql_query("SELECT * FROM  series_master_list");
  

$sql=mysql_query("INSERT INTO series_master_list (series) VALUES ('$series')")or die(mysql_error());
...
<tr>
	...
	<td>
        ...
        <th valign="top">series:</th>
			<td><input type="text" class="inp-form" name="series" id="series" required/></td>         
	   </tr>
