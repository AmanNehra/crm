...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login" style="margin-bottom:10px;">
		<img src="images/logo_skyland.png" width="250" height="55" alt="" />
	</div>
	<!-- end logo -->
	...
	<div id="login-inner">
		...
		<tr>
			<th>UserID</th>
			<td><input type="text"  class="login-inp" name="user_name" /></td>
		</tr>
		<tr>
			<th>Password</th>
		...
		<?php /*?><tr>
			<th></th>
			<td valign="top"><input type="checkbox" class="checkbox-size" id="login-check" name="remember" value="1" /><label for="login-check">Remember me</label></td>
		</tr><?php */?>
		<tr>
			<th></th>
			<td><input type="submit" class="submit-login"  onclick="msg()" /></td>
		</tr>
		</table>
	</div>
 	<!--  end login-inner -->
