...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>All Discount Grade Listing</h1>
	</div>
    <div style="width:100%;">
     
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="add_discount_grade.php" style="color:#FFFFFF;">Add New Discount Grade</a></span>
    </div>
			...
			<div id="table-content">
				...
				<tr>
                   ...
                   <!-- <th class="table-header-repeat line-left"><a>Profile Image</a></th>-->
                    <th class="table-header-repeat line-left"><a>Grade</a></th>
					 
                     <th class="table-header-repeat line-left"><a>Value</a></th>
	...
	*/
	...
	$tbl_name="discount_grade_list";		//your table name
	...
	*/
	...
	$targetpage = "discount_grade_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  <td><?php echo $count; ?></td>
					...
					<a href="discount_grade_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
                  <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=discount&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onClick="if(!confirm('Are you sure, you want to delete this Information ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				<?php } ?>
