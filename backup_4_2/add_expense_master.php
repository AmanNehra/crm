...
<div id="page-heading">
  <h1>Add NewExpense Head Master Information</h1>
...
<tr>
	...
	<td>
        ...
        <th valign="top">Head:</th>
			<td><input type="text" class="inp-form" name="head" id="head" required/></td>
          <th valign="top">Parent:</th>
			<td><input type="text" class="inp-form" name="parent" id="parent" required/></td> 
