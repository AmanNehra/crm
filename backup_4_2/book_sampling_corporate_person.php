  ...
  for($j=1; $j<=$len; $j++)
     {
	   ...
	   if($sampling_type!='BOOKS_GIVEN')
	    $q2=mysql_query("INSERT INTO book_sample_details (uid,salseman_id,teacher_id,relate,sampling_Date) VALUES('$uid','$salesman_id','$teacher_id','CONTACT_PERSON','$sampling_Date')")  or die( mysql_error());
		
	   if(isset($book_id))	     
			$q2=mysql_query("INSERT INTO book_sample_details (uid,salseman_id,teacher_id,book_id,qty,relate,sampling_Date) VALUES('$uid','$salesman_id','$teacher_id','$book_id','$specimen_qty','CONTACT_PERSON','$sampling_Date')")  or die( mysql_error());
...
<div id="page-heading">
  <h1>Book Sampling Corporate Person </h1>
</div>
...
<tr>
	...
	<?php //echo '<pre>'; print_r ($re_sample);?>
        ...
        <tr>
			...
			<td><input type="text" name="name"  class="inp-form33" value="<?php echo $re_sample->persion;?>"/>
</td>
