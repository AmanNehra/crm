      ...
      <?php			    
	   ...
	   <tr>
        ...
        <th valign="top">Tour Advance  Bal Rs:</th>			
			<td> <input type="text" class="inp-form" name="advance_bal" id="advance_bal" value="<?php echo $row['advance']; ?>" /></td>  
	   </tr>	   
	  ...
	  <tr id="d22" >
	   ...
	   <tr id="d31">
          ...
          <th valign="top">Local DA:</th>
			<td><input type="text" class="inp-form" name="da" id="a3" value="<?php echo $row['da']; ?>"  onChange="sum3(this.value)" readonly="readonly"/></td>
			<th valign="top">Boarding / Lodging:</th>
			<td><input type="text" class="inp-form" name="bord" id="a4" value="<?php echo $row['boarding']; ?>" onChange="sum3(this.value)" readonly="readonly" /></td> 
	   </tr>
	   <tr id="d32" >
	   
          <th valign="top">Fooding:<b style="font-size: 9px;">(Breakfast/Lunch/Dinner)</b></th>
			<td><input type="text" class="inp-form" name="food" value="<?php echo $row['fooding']; ?>" id="a5" onChange="sum3(this.value)" readonly="readonly" /></td>
            <td><input type="text" class="inp-form" name="a25" id="a25"  value="0" readonly="readonly" style="margin-right: 12px;
"/></td>
			<td><input type="text" class="inp-form" name="a26" id="a26"  value="0" readonly="readonly"/></td>
	   </tr>	                 
