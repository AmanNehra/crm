	...
	<td>
      ...
      <?php			    
	   ...
	   <tr>
		...
		<tr>
		<?php	
  $query99=mysql_query("SELECT * FROM tour WHERE (executive_id='$rty') order by id desc limit 1");
  $data99=mysql_fetch_array($query99);
  $da99=$data99['advance'];
?>					
        ...
        <th valign="top">Tour Advance  Bal Rs:</th>			
			<td> <input type="text" class="inp-form" name="advance_bal" id="advance_bal" value="<?php echo $da99; ?>" readonly="readonly"/></td>  
	   </tr>	   
	   <tr>
	  ...
	  <tr id="d22">
	   ...
	   <tr id="d31" >
          ...
          <th valign="top">Local DA:</th>
			<td><input type="text" class="inp-form" name="da" id="a3"  value="0" onChange="sum3(this.value)" readonly="readonly"/></td>
			<th valign="top">Boarding / Lodging:</th>
			<td><input type="text" class="inp-form" name="bord" id="a4"  value="0" onChange="sum3(this.value)" readonly="readonly"/></td> 
	   </tr>
	   <tr id="d32" >
	   
          <th valign="top">Fooding:<b style="font-size: 9px;">(Breakfast/Lunch/Dinner)</b></th>
			<td><input type="text" class="inp-form" name="food" id="a5"  value="0" onChange="sum3(this.value)" readonly="readonly"/></td>
