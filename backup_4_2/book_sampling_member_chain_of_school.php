...
$q="INSERT INTO book_sample (id_of_name,name, address, city,district, state, country,salseman_id,salesman_name,sampling_type,group1,series,relate,remarks,sampling_Date) VALUES ('$sid','$name','$address','$city', '$district','$state', '$country','$salesman_id','$salesman_name','$sampling_type','$group','$series','MEMBER','$remarks','$sampling_Date' )";
  ...
  for($j=1; $j<=$len; $j++)
     {
	   ...
	   if($sampling_type!='BOOKS_GIVEN')
	    $q2=mysql_query("INSERT INTO book_sample_details (uid,salseman_id,teacher_id,relate,sampling_Date) VALUES('$uid','$salesman_id','$teacher_id','MEMBER','$sampling_Date')")  or die( mysql_error());
		
	   else if(isset($book_id))	     
			$q2=mysql_query("INSERT INTO book_sample_details (uid,salseman_id,teacher_id,book_id,qty,relate,sampling_Date) VALUES('$uid','$salesman_id','$teacher_id','$book_id','$specimen_qty','MEMBER','$sampling_Date')")  or die( mysql_error());
...
<div id="page-heading">
  <h1>Book Sampling Member Chain Of School </h1>
</div>
