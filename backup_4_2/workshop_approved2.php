...
$q= mysql_query("UPDATE workshop SET executive_id='$executive_id',executive='$executive',designation='$designation',venue='$venue',school='$school',v_detail='$v_detail',proposed_date='$proposed_date',proposed_time='$proposed_time',resource_person='$resource_person',subject='$subject',board='$board',Schools_invited='$Schools_invited',participate_teachers='$participate_teachers',tea='$tea',lunch='$lunch',estimated_cost='$estimated_cost',goal='$goal',remarks='$remarks',status='2',approved_by='$usname' WHERE id='$id'") or die(mysql_error());
...
if($q && $q1) {
  mysql_query("COMMIT");
  header('location:workshop_listing_approved2.php');
 }
else
...
<div id="message-red">
				...
				<div id="page-heading">
  <h1>Workshop Voucher Approved2</h1>
</div>
				<div class="addin">
    	Back
    </div></a>
