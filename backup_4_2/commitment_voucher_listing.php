...
$salesman_name=user_names($userid);
...
<div id="content">
	...
	<div id="page-heading" style="display:inline;width:41.3%;; float:left">
		<h1>All Commitemnt Voucher Listing</h1>		
	</div>
    ...
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="commitment_voucher.php" style="color:#FFFFFF;">Add New Voucher</a></span>
    </div>
    <form name="search" action="#" method="post">
	...
	<td> 
         <select name="searchby1" class="search_by" >
		        <option value="" selected="selected">Plz Select</option> 			
				<option <?php if($searchby1=="c_no") echo 'selected="selected"';?>VALUE="c_no">Commitment No</option>	
				<option <?php if($searchby1=="c_date") echo 'selected="selected"';?>VALUE="c_date">Date</option>
				
				<option <?php if($searchby1=="commited_by") echo 'selected="selected"';?>VALUE="commited_by">Commitment By</option>						
				<option <?php if($searchby1=="c_year") echo 'selected="selected"';?>VALUE="c_year">Year</option>
				<option <?php if($searchby1=="pay_mode") echo 'selected="selected"';?>VALUE="pay_mode">Pay Mode</option>
				<option <?php if($searchby1=="school") echo 'selected="selected"';?>VALUE="school">School</option>
				<option <?php if($searchby1=="designation_teacher") echo 'selected="selected"';?>VALUE="designation_teacher">Designation</option>
				<option <?php if($searchby1=="corporate") echo 'selected="selected"';?>VALUE="corporate">Corporate</option>			
				<option <?php if($searchby1=="c_persion") echo 'selected="selected"';?>VALUE="c_persion">C. Person</option>
				<option <?php if($searchby1=="gift_pad") echo 'selected="selected"';?>VALUE="gift_pad">Gift Pad Type</option>
				<option <?php if($searchby1=="gift_percent") echo 'selected="selected"';?>VALUE="gift_percent">Gift %</option>	
				
				<option <?php if($searchby1=="total_discount") echo 'selected="selected"';?>VALUE="total_discount">Total Amount</option>		
	...
	<td> 
         <select name="searchby2" class="search_by">
		        <option value="" selected="selected">Plz Select</option> 			
				<option <?php if($searchby2=="c_no") echo 'selected="selected"';?>VALUE="c_no">Commitment No</option>	
				<option <?php if($searchby2=="c_date") echo 'selected="selected"';?>VALUE="c_date">Date</option>
				
				<option <?php if($searchby2=="commited_by") echo 'selected="selected"';?>VALUE="commited_by">Commitment By</option>						
				<option <?php if($searchby2=="c_year") echo 'selected="selected"';?>VALUE="c_year">Year</option>
				<option <?php if($searchby2=="pay_mode") echo 'selected="selected"';?>VALUE="pay_mode">Pay Mode</option>
				<option <?php if($searchby2=="school") echo 'selected="selected"';?>VALUE="school">School</option>
				<option <?php if($searchby2=="designation_teacher") echo 'selected="selected"';?>VALUE="designation_teacher">Designation</option>
				<option <?php if($searchby2=="corporate") echo 'selected="selected"';?>VALUE="corporate">Corporate</option>			
				<option <?php if($searchby2=="c_persion") echo 'selected="selected"';?>VALUE="c_persion">C. Person</option>
				<option <?php if($searchby2=="gift_pad") echo 'selected="selected"';?>VALUE="gift_pad">Gift Pad Type</option>
				<option <?php if($searchby2=="gift_percent") echo 'selected="selected"';?>VALUE="gift_percent">Gift %</option>	
	...
	function export_excel()
	{
	 ...
	 <form name="search_export" id="search_export" action="commitment_voucher_listing_export.php" method="post">
		...
		<div id="content-table-inner">
			...
			<div id="table-content" align="center">
				...
				<tr>
				   ...
				   <th class="table-header-repeat line-left"><a>Commitment Number </a></th>
				   <th class="table-header-repeat line-left"><a>Date</a></th>
				   <th class="table-header-repeat line-left"><a>Commitment By </a></th>
				   <th class="table-header-repeat line-left"><a>Year</a></th>
				   <th class="table-header-repeat line-left"><a>Pay Mode </a></th>
				   <th class="table-header-repeat line-left"><a>School</a></th>
				   <th class="table-header-repeat line-left"><a>To Be Given </a></th>
				   <th class="table-header-repeat line-left"><a>Designation</a></th>
				   <th class="table-header-repeat line-left"><a>Corporate</a></th>
				   <th class="table-header-repeat line-left"><a>C.Person</a></th>
				   <th class="table-header-repeat line-left"><a>Gift Paid</a></th>
                   ...
                   <th class="table-header-repeat line-left"><a>Download File</a></th>
	...
	*/
	...
	$tbl_name="commitment_voucher";		//your table name
	...
	*/
    ...
    if($user <=4 ) 
	{
    	if($show_list!=""){
    	   ...
    	   $query = "SELECT COUNT(*) as num FROM $tbl_name WHERE $show";
     ...
     else
     {
        if($show_list!=""){
    	   ...
    	   $query = "SELECT COUNT(*) as num FROM $tbl_name WHERE $show AND `commited_by` IN ($salesman_name)";
    	  
    	}
    	else{
    	   
    	   $query = "SELECT COUNT(*) as num FROM $tbl_name WHERE $showAll  $search_val AND `commited_by` IN ($salesman_name)";
        }        
	...
	$targetpage = "commitment_voucher_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
    ...
    if($user <=4 ) 
	{
     ...
     else
     {
        if($show_list!=""){
    	   ...
    	   $sql ="SELECT * FROM $tbl_name WHERE $show AND `commited_by` IN ($salesman_name) ORDER BY id DESC LIMIT $start, $limit";
    	       	  
    	}
    	else{
    	   
           $sql = "SELECT * FROM $tbl_name WHERE $showAll  $search_val AND `commited_by` IN ($salesman_name) ORDER BY id DESC LIMIT $start, $limit";
...
?>
                ...
                <?php  //$result=mysql_query("SELECT * FROM dan_users ORDER BY c_no desc") or die(mysql_error); 
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  ?>
					...
					<td><?php echo $row['commited_by']; ?></td>
					<td><?php echo $row['c_year']; ?></td>
					<td><?php echo $row['pay_mode']; ?></td>
					<td><?php echo $row['school']; ?></td>
					<td><?php echo $row['given']; ?></td>
					<td><?php echo $row['designation_teacher']; ?></td>
					<td><?php echo $row['corporate']; ?></td>
					<td><?php echo $row['c_persion']; ?></td>
					<td><?php echo $row['gift_pad']; ?></td>
					<td><?php echo $row['gift_percent']; ?></td>
					<td><?php echo $row['total_discount']; ?></td>
					<td><?php echo $row['remarks']; ?></td>						
					
					<td><a href="upload/<?php echo $row['attachment']; ?>" download>Download</a></td>
					...
					<a href="commitment_voucher_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
                 <?php  if($user==1 || $user==2) { ?> 
					<a href="delete.php?type=commit&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onClick="if(!confirm('Are you sure, you want to delete this Information ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				<?php } ?>
				</td>
				<?php //}?>
