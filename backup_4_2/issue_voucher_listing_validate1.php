...
<div id="content">
	...
	<div id="page-heading" style="display:inline;width:70%; float:left">
		<h1>Non Approved Specimen Voucher Listing Validate1</h1>		
	</div>   
	...
	*/
	...
	$targetpage = "issue_voucher_listing_validate1.php"; 	//your file name  (the name of this file)
	$limit = 10;
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  ?>
					...
					<a href="issue_voucher_validate1.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>				
