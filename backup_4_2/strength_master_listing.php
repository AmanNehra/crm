...
<div id="content">
    ...
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="strength_master.php" style="color:#FFFFFF;">Add New Strength Information</a></span>
    </div><?php }?>
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  ?>
					...
					<a href="strength_info_edit.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>
