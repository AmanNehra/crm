...
//echo "<pre>"; print_r ($_REQUEST); die("submit");
	...
	$q="UPDATE book_sample SET name='$name',address='$address', city='$city',district='$district', state='$state', country='$country',salseman_id='$salesman_id',salesman_name='$salesman_name',sampling_type='$sampling_type', group1='$group',series='$series',remarks='$remarks',sampling_Date='$sampling_Date',app='$app' where id='$id'";
...
header("Location : http://mascoteducation.com/crm/book_sampling_details.php");
echo "<script>window.location.href='http://mascoteducation.com/crm/book_sampling_details.php';</script>";
