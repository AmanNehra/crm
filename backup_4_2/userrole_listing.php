...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>All User Roles Listing</h1>
	</div>
     
    <div class="addin">
    	<span><a href="userrole_add.php" style="color:#FFFFFF;">Add New User Role</a></span>
    </div>
	<!-- end page-heading -->
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
                    ...
                    <th class="table-header-repeat line-left"><a>Role Name</a></th>
	...
	*/
	...
	$tbl_name="dan_users_role_type";		//your table name
	...
	*/
	...
	$targetpage = "userrole_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
