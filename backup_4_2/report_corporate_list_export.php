...
if($specialisation!="" && $category!="" && $country!="" && $state!="" && $district!="" && $city!="")
	   $query = "SELECT * FROM $tbl_name WHERE(specialisation1='$specialisation' OR specialisation2='$specialisation' OR specialisation3='$specialisation' OR specialisation4='$specialisation') AND category='$category' AND country='$country' AND state='$state' AND district='$district' AND city='$city'";
	else if($specialisation!="" && $category!="" && $country!="" && $state!="" && $district!="")
	   $query = "SELECT * FROM  $tbl_name WHERE (specialisation1='$specialisation' OR specialisation2='$specialisation' OR specialisation3='$specialisation' OR specialisation4='$specialisation') AND category='$category' AND country='$country' AND state='$state' AND district='$district'";
	 else
