...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>All Session Master Information Listing</h1>
	</div>
    <div style="width:100%;">
      <?php if($user==1){ ?>
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="add_session_master_info.php" style="color:#FFFFFF;">Add New Session Master Information</a></span>
    </div><?php }?>
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE category = 'Session Master' ";
	...
	$targetpage = "session_master_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
...
//echo $page;die;
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name WHERE category = 'Session Master' ORDER BY id desc LIMIT $start, $limit";
...
if ($i % 2 == 0) {
  ...
  echo "<tr class='alternate-row'>";
				...
				<td><?php echo $count; ?></td>
					...
					<a href="delete.php?type=session_master_info&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onClick="if(!confirm('Are you sure, you want to delete this Information Details ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  <td><?php echo $count; ?></td>
					...
					<a href="delete.php?type=session_master_info&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onClick="if(!confirm('Are you sure, you want to delete this Information ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
