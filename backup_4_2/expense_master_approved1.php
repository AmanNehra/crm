...
<div id="page-heading">
  <h1>Expense Master Approved 1 </h1>
      ...
      <?php			    
	   ...
	   <tr>
        ...
        <th valign="top">Tour Advance  Bal Rs:</th>			
			<td> <input type="text" class="inp-form" name="advance_bal" value="<?php echo $row['advance']; ?>" /></td>  
	   </tr>	   
	  ...
	  <tr id="d22" >
	   ...
	   <tr id="d32" >
          ...
          <th valign="top">Fooding:</th>
			<td><input type="text" class="inp-form" name="food" value="<?php echo $row['fooding']; ?>" id="a5"  /></td>
	   </tr>	   
