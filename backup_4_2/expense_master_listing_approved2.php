...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Non Approved Expense Master Listing Validate 2 </h1>
	</div>
	...
	*/	
	...
	$targetpage = "expense_master_listing_approved2.php"; 	//your file name  (the name of this file)
	$limit = 10;
  ...
  echo "<tr class='alternate-row'>";
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  ?>
					...
					<a href="expense_master_approved2.php?id=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Edit" class="icon-1 info-tooltip"></a>			
