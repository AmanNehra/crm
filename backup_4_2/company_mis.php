...
$sql=mysql_query("INSERT INTO misCompanyMaster (code, name, address,city,district, state, country, pin, std, phone1,phone2,mobile1, mobile2,fax1,fax2, web, email, remarks) VALUES ('$code', '$name' , '$address','$city', '$district','$state', '$country', '$pin', '$std', '$phone1', '$phone2','$mobile1','$mobile2','$fax1','$fax2', '$web','$email', '$remarks')")or die(mysql_error());
...
<tr>
	...
	<td>
	    ...
	    <?php
		$mis_no=mt_rand(1,10).time();		
		?>
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        
        <input type="hidden" class="inp-form" name="code" value="<?php echo "Cm".$mis_no; ?>"  required />
		<tr>
        ...
        <tr>
         ...
         <tr>
			...
			<td><input type="text" pattern="[0-9]*" title="Enter only number" class="inp-form" name="mobile1" id="mobile"  /></td>
			<th valign="top">Mobile 2:</th>
			<td><input type="text" pattern="[0-9]*" title="Enter only number" class="inp-form" name="mobile2" id="mobile"  /></td>
		</tr>
        
         <tr>
			<th valign="top">Fax No1:</th>
			<td><input type="text" class="inp-form" name="fax1" id="fax" /></td>
			<th valign="top">Fax No2:</th>
			<td><input type="text" class="inp-form" name="fax2" id="fax" /></td>
         </tr>
