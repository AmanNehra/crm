...
$query="select category from department";
...
$sql=mysql_query("INSERT INTO department (id,category, department, date) VALUES ('','$category', '$department','$date')")or die(mysql_error());
...
<div id="page-heading">
  <h1>Add New Department Information</h1>
...
<tr>
   ...
   <th valign="top">Category:</th>
            ...
            <input type="text" class="inp-form" name="category" id="category"  readonly="readonly" value="DEPARTMENT"/></td>
            
   <th valign="top">Department Name:</th>
			<td>
           
            <input type="text" class="inp-form" name="department" id="department" required/></td>
