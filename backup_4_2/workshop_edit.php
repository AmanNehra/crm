...
$q= mysql_query("UPDATE workshop SET executive_id='$executive_id',executive='$executive',designation='$designation',venue='$venue',school='$school',v_detail='$v_detail',proposed_date='$proposed_date',proposed_time='$proposed_time',resource_person='$resource_person',subject='$subject',board='$board',Schools_invited='$Schools_invited',participate_teachers='$participate_teachers',tea='$tea',lunch='$lunch',estimated_cost='$estimated_cost',goal='$goal',remarks='$remarks'  WHERE id='$id'") or die(mysql_error());
...
<tr>
    ...
    <tr>
        <th valign="top">Lunch/Dinner :</th>
         ...
         <th valign="top">Estimated Cost:</th>
