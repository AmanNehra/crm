...
$sql=mysql_query("INSERT INTO `wp_enquiry` ( `id` , `name` , `email` , `mobile` , `query` , `date` , `ip` )
VALUES (
NULL , '$name', '$email', '$mobile', '$query', '$date', '$ip'
)")or die(mysql_error());
    if($sql){
...
<tr>
	...
	<td>
      ...
      <tr>
			...
			<td><input type="text" class="inp-form" name="date" id="date" maxlength="19" /><br />yyyy-mm-dd:hh:mm:ss</td>
			<td></td>
		</tr>
	<tr>
		<th>&nbsp;</th>
