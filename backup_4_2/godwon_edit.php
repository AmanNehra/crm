...
$state=trim(strtoupper($_REQUEST['state']));
  ...
  $sql=mysql_query("UPDATE godwon_list SET name='$name',city='$city',district='$district',state='$state' WHERE id='$id'")or die(mysql_error());
    if($sql)
...
<tr>
	...
	<td>
       ...
       <tr>      
			...
			<td><input type="text" class="inp-form" name="district" id="district" value="<?php echo $row['district']; ?>" readonly="readonly" required/></td>            <th valign="top">State:</th>
			<td><input type="text" class="inp-form" name="state" id="state" value="<?php echo $row['state']; ?>" readonly="readonly" required/></td>  
	   </tr> 
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
