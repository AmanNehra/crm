...
$query=mysql_query("SELECT * FROM  other_designation_list");
  ...
  if($f!=1)
   { 
$sql=mysql_query("INSERT INTO other_designation_list (department,designation, date_added) VALUES ('$department','$designation','$date')")or die(mysql_error());
...
<div id="page-heading">
  <h1>Add Other Designation Details</h1>
...
<tr>
	...
	<td>
        ...
        <th valign="top">Department:</th>
			...
			<select name="department" class="inp-form-select" id="department" onchange="showlocation(this.value)">
			 <option value="" selected="selected">Plz select</option>
			      <?php			    
			    $query=mysql_query("SELECT id,department FROM department ORDER BY department ");
          ...
          <th valign="top">Designation:</th>
			<td><input type="text" class="inp-form" name="designation" id="designation"  required/></td>   
	   </tr>
