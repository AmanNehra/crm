...
$sql=mysql_query("INSERT INTO school_info_list (category, name, date_added) VALUES ('$category', '$name','$date')")or die(mysql_error());
     header('location:school_info_listing.php'); 
}
...
<div id="page-heading">
  <h1>Add New School Information</h1>
</div>
...
<tr>
	...
	<td>
        ...
        <th>Category:</th>
        <td>
         <select name="category" style="width: 390px;;border: 1px solid;height: 30px;border-radius: 4px;"> 
       <option VALUE="Board" selected="selected">Board</option>
        <option VALUE="Category">Category</option>
         ...
         <option VALUE="Session Master">Session Master</option>
