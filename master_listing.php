...
<div id="content">
    ...
    <div class="addin" style="width:auto; float:right;">
    	<span><a href="master.php" style="color:#FFFFFF;">Add New School Master</a></span>
    </div>    
	...
	<td> 
         <select name="searchby1" class="search_by">
				...
				<option <?php if($searchby1=="aff") echo 'selected="selected"';?>VALUE="aff">Aff No</option>
				<option <?php if($searchby1=="board") echo 'selected="selected"';?>VALUE="board">Board</option>
				<option <?php if($searchby1=="category") echo 'selected="selected"';?>VALUE="category">Category</option>
				...
				<option <?php if($searchby1=="mobile") echo 'selected="selected"';?>VALUE="mobile">Mobile1</option>
				<option <?php if($searchby1=="route") echo 'selected="selected"';?>VALUE="route">Route NO</option>
           		<option <?php if($searchby1=="submission") echo 'selected="selected"';?>VALUE="submission">Submission</option>				
                <option <?php if($searchby1=="finalised") echo 'selected="selected"';?>VALUE="finalised">Finalised</option>
                <option <?php if($searchby1=="satoff") echo 'selected="selected"';?>VALUE="satoff">Sat off</option>
            	<option <?php if($searchby1=="ptm") echo 'selected="selected"';?>VALUE="ptm ">PTM </option>                      
        </select>
      </td> 
	...
	<td> 
         <select name="searchby2" class="search_by">
				...
				<option <?php if($searchby2=="aff") echo 'selected="selected"';?>VALUE="aff">Aff No</option>
				<option <?php if($searchby2=="board") echo 'selected="selected"';?>VALUE="board">Board</option>
				<option <?php if($searchby2=="category") echo 'selected="selected"';?>VALUE="category">Category</option>
				...
				<option <?php if($searchby2=="mobile") echo 'selected="selected"';?>VALUE="mobile">Mobile1</option>
				<option <?php if($searchby2=="route") echo 'selected="selected"';?>VALUE="route">Route NO</option>
           		<option <?php if($searchby2=="submission") echo 'selected="selected"';?>VALUE="submission">Submission</option>				
                <option <?php if($searchby1=="finalised") echo 'selected="selected"';?>VALUE="finalised">Finalised</option>
                <option <?php if($searchby1=="satoff") echo 'selected="selected"';?>VALUE="satoff">Sat off</option>
            	<option <?php if($searchby1=="ptm") echo 'selected="selected"';?>VALUE="ptm ">PTM </option>    
        </select>
			...
			<div id="table-content">
				...
				<tr>
                   ...
                   <!-- <th class="table-header-repeat line-left"><a>Profile Image</a></th>-->
					...
					<th class="table-header-repeat line-left"><a>Book List</a></th>					
					<th class="table-header-repeat line-left"><a>Teacher Master</a></th>
					<th class="table-header-repeat line-left"><a>sampling</a></th>  

                    <th class="table-header-options line-left" style="border-right:1px solid;"><a>Options1</a></th>                                     
	...
	*/
	...
	$targetpage = "master_listing.php"; 	//your file name  (the name of this file)
	$limit = 10;
  ...
  echo "<tr class='alternate-row'>";   
				 ...
				 /* $len=strlen($ag_id);
				  ...
				  <td><?php echo $count; ?></td>
                    ...
                    <td align="center"><a href="book_master.php?sid=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Book Master" class="icon-4 info-tooltip"></a></td>                   
                    
                    <td align="center"><a href="teacher_master.php?sid=<?php echo base64_encode(convert_uuencode($row['id']));?>" title="Teacher Master" class="icon-4 info-tooltip"></a></td>
				     <td align="center"><a href="book_sampling_school.php?sid=<?php echo base64_encode(convert_uuencode($row['id']));?>&type=<?php echo base64_encode(convert_uuencode($tbl_name));?>" title="Teacher Master"><img src="images/sicon.png"/></a></td>
                  ...
                  <?php  if($user==1 || $user==2) { ?>
					<a href="delete.php?type=master&id=<?php echo base64_encode(convert_uuencode($row['id']));?>" onclick="if(!confirm('Are you sure, you want to delete this Master Details ?')){return false;}" title="Delete" class="icon-2 info-tooltip" ></a>
				  <?php } ?>
